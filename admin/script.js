...
const documentRequirements = {
    ...
    "લગ્ન નોંધણો માટેના પુરાવા ની યાદી": ["લીવીંગ સર્ટી  (વર તથા કન્યા ના)", "આધાર કાર્ડ (વર તથા કન્યા ના)", "રેશન કાર્ડ (વર તથા કન્યા ના)", "વર તથા કન્યા ના માતા પિતા ના આધાર કાર્ડ", "ગોર અદાનું આધાર કાર્ડ", "બે સાક્ષી ના આધાર કાર્ડ", "લગ્ન કંકોત્રી ", "લગ્ન ના જોઈટ ફોટા લગ્ન વિધિ વખતના ૪ x ૬ ની સાઈઝ માં", "નોંધ:- લગ્ન સ્થળ ગામડા માં હોય તો દરેક પુરાવાની ૨ નકલ આપવી.",],
