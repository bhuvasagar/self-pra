...
const servicesData = [
    ...
    },
    {
        ...
        subServices: [
            ...
            { name: "પાલક માતા પીતા", nameEn: "Palk Maata Pitta", description: "પાલક માતા પીતા માટે" },
        ]
    },
    {
        title: "ઓનલાઇન સેવાઓ",
...
const documentRequirements = {
    "પાલક માતા પીતા":[ "બાળકનો જન્મ દાખલો", "બાળકનુ આધાર કાર્ડ ની ઝેરોક્ષ", "બાળકનું સ્કુલ બોનાફાઇડ", "બાળકના માતા પીતાના મારણ દાખલા તથા આધાર કાર્ડ ", "બાળકનો ફોટો સિંગલ", "બાળકનો ફોટો પાલક માતા પીતા સાથે જોઇન્ટ માં", "બાળકની બેન્ક પાસબુક પાલક માતા પીતા સાથે જોઇન્ટ માં", "પાલક માતા પીતા કુપન ની ઝેરોક્ષ", "પાલક માતા પીતા આધાર કાર્ડ ની ઝેરોક્ષ", "પાલક પીતા નો આવક દાખલો", "લાઇટ બીલ ની ઝેરોક્ષ",],
    ...
    "લગ્ન નોંધણી માટેના પુરાવા ની યાદી": ["લીવીંગ સર્ટી  (વર તથા કન્યા ના)", "આધાર કાર્ડ (વર તથા કન્યા ના)", "રેશન કાર્ડ (વર તથા કન્યા ના)", "વર તથા કન્યા ના માતા પિતા ના આધાર કાર્ડ", "ગોર અદાનું આધાર કાર્ડ", "બે સાક્ષી ના આધાર કાર્ડ", "લગ્ન કંકોત્રી ", "લગ્ન ના જોઈટ ફોટા લગ્ન વિધિ વખતના ૪ x ૬ ની સાઈઝ માં", "નોંધ:- લગ્ન સ્થળ ગામડા માં હોય તો દરેક પુરાવાની ૨ નકલ આપવી.", ],
    ...
    "સ્કોલરશીપ ફોર્મ": ["વિદ્યાર્થીનું આધાર કાર્ડ", "વિદ્યાર્થીની બેંક પાસબુક", "અભ્યાસની તમામ માર્કશીટ", "વિદ્યાર્થીનો જ્ઞાતિનો દાખલો", "સ્કુલ લીવીંગ સર્ટીફીકેટ", "સ્કુલ/કોલેજ બોનાફાઈડ સર્ટીફીકેટ", "વાલીનો આવકનો દાખલો", "વિદ્યાર્થીનો ફોટો", "હોસ્ટેલફીની પહોચ (લાગુ પડતું હોય તો)", "સ્કુલ-કોલેજ ફી ભર્યાની પહોચ", "ગેપ સર્ટીફીકેટ 1 વર્ષથી વધુ ગેપ હોય તો"],
};
