    ...
    subServices: [
      {
        ...
        description: "આવકના પુરાવા માટે",
      },
      {
        name: "જાતિનું દાખલો",
        nameEn: "Caste Certificate",
        description: "જાતિના પુરાવા માટે",
      },
      {
        name: "જન્મ દાખલો",
        nameEn: "Birth Certificate",
        description: "જન્મના પુરાવા માટે",
      },
      {
        name: "મૃત્યુ દાખલો",
        nameEn: "Death Certificate",
        description: "મૃત્યુના પુરાવા માટે",
      },
      {
        name: "બિન અનામત દાખલા",
        nameEn: "Non-reserved instance",
        description: "બિન અનામત દાખલા માટે",
      },
      {
        name: "૧૦% (E.W.S.)અનામત વગના દાખલા",
        nameEn: "10% (E.W.S.) Reservation Scheme Example",
        description: "૧૦% (E.W.S.)અનામત влияના દાખલા માટે",
      },
      {
        name: "ડોમીસાઈલ સર્ટી",
        nameEn: "Domicile Certificate",
        description: "ડોમીસાઈલ સર્ટી માટે",
      },
      {
        name: "નોન ક્રિમીલેયર સર્ટી",
        nameEn: "Non-creamy layer Certificate",
        description: "નોન ક્રિમીલેયર સર્ટી માટે",
      },
      {
        name: "સીનીયર સીટીઝન પ્રમાણપત્ર ",
        nameEn: "Senior Citizen Certificate",
        description: "સીનીયર સીટીઝન પ્રમાણપત્ર માટે",
      },
      {
        name: "વિચરતી-વિમુક્ત જાતિ દાખલો ",
        nameEn: "NT-DNT Certificate",
        description: "વિચરતી-વિમુક્ત જાતિ દાખલો માટે",
      },
    ],
  },
  {
    ...
    subServices: [
      {
        name: "વિધવા સહાય માટે",
        nameEn: "For widow assistance",
        description: "વિધવા સહાય માટે",
      },
      {
        name: "વ્રુધ્ધ પેન્સન માટે",
        nameEn: "pension assistance",
        description: "વ્રુધ્ધ સહાય માટે",
      },
      {
        name: "વ્હાલી દીકરી સહાય",
        nameEn: "Dear Daughter",
        description: "વ્હાલી દીકરી સહાય માટે",
      },
      {
        name: "કુવરબાઈ મામેરુ સહાય",
        nameEn: "Kuvarbai Mameru",
        description: "કુવરબાઈ મામેરુ સહાય માટે",
      },
    ],
  },
  {
    ...
    subServices: [
      {
        ...
        description: "પાસપોર્ટ અરજી અને સેવાઓ",
      },
      {
        name: "વોટર આઈડી",
        nameEn: "Voter ID",
        description: "મતદાર ઓળખ કાર્ડ સેવાઓ",
      },
      {
        name: "ઇ -શ્રમ કાર્ડ",
        nameEn: "E-shram card",
      ...
      },
      {
        name: "ઉદ્યમ આધાર",
        nameEn: "udyam aadhar",
        description: "ઉદ્યમ આધાર માટના પરાવા ની યાદી",
      },
    ],
  },
  {
    ...
    subServices: [
      {
        name: "લાઇટ કનેક્શન",
        nameEn: "Light connection",
        description: "લાઇટ કનેક્શન",
      },
      {
        name: "પાન કાર્ડ - નવું અને સુધારણા",
        nameEn: "Pan Card -New and Correction",
        description: "પાન કાર્ડ - નવું અને સુધારણા સેવાઓ",
      },
      {
        name: "ભાડા કરાર",
        nameEn: "Rent Agreement",
        description: "ભાડા કરાર સેવાઓ",
      },
      {
        name: "રેશન કાર્ડ",
        nameEn: "Ration Card",
        description: "રેશન કાર્ડ અરજી અને સેવાઓ",
      },
      {
        name: "ભાગીદારી દસ્તાવેજ",
        nameEn: "PARTNARSHIP DEED",
        description: "ભાગીદારી દસ્તાવેજ",
      },
    ],
  },
];
